...
- Source zip: https://github.com/JonathanKHobson/critical-compass/releases/download/v0.1.0-beta.4/critical-compass-source.zip
  ...
  <main>
    ...
    <section id="faq" class="tab-panel" role="tabpanel" aria-labelledby="tab-faq" hidden>
      ...
      <div class="card">
        ...
        <p>Critical Compass is designed to run locally, uses bundled files, requires no API key, and avoids background scanning. Claude's warning is the generic warning it shows for locally shared third-party plugins and extensions. All internet-downloaded MCPs and plugins carry some risk, including malicious code, prompt injection, unexpected file access, or external API calls, so review the files with Claude, Codex, or a trusted technical reviewer before installing.</p>
      </div>
      <div class="card">
    ...
    <section id="advanced" class="tab-panel" role="tabpanel" aria-labelledby="tab-advanced" hidden>
      <div class="card">
        ...
        <section>
          ...
          <p><a class="button ghost" href="https://github.com/JonathanKHobson/critical-compass/releases/download/v0.1.0-beta.4/critical-compass-source.zip" download>Download Source Zip</a></p>
        </section>
        <details>
